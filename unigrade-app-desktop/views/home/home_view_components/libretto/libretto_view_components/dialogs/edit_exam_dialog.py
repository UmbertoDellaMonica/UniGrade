...
class EditExamDialog(ctk.CTkToplevel):
    def __init__(self, master, student_id, values):
        super().__init__(master)
        self.result = None
        self.student_id = student_id
        self.title("Modifica Esame")
        self.geometry("400x400")
        self.grab_set()
        self.resizable(False, False)

        # Titolo
        ctk.CTkLabel(self, text="✏️ Modifica Esame", font=("Arial", 18, "bold")).pack(
            pady=(20, 10)
        )
        ...
        self.exam_name.insert(0, values[0])
        ...
        self.vote_combo.set(str(values[1]))
        ...
        self.cfu_entry.insert(0, values[2])
    ...
    def _on_submit(self):
        ...
        # Calcola automaticamente lo stato in base al voto
        ...
        self.result = {"nome": nome, "vote": voto, "cfu": cfu}
        self.destroy()
